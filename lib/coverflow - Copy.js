...
(function() {
    ...
    function keyDown( event ) {
        ...
        switch( event.keyCode ) {
            case 37: flowRight(); event.preventDefault(); break; // left
            case 39: flowLeft(); event.preventDefault(); break; // right
            case 13: selectGame(); event.preventDefault(); break; // enter/accept
        }
    ...
    function selectGame()
    {
        console.log(_albums[_index].id);
        window.location.href = "./?page=showgame&id=" + _albums[_index].id;
    }
